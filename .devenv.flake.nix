{
  inputs =
    let
      version = "1.10.0";
system = "x86_64-linux";
devenv_root = "/home/dev/sahara/web3/a2a/x402-rs";
devenv_dotfile = "/home/dev/sahara/web3/a2a/x402-rs/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-d00d936";
...
hostname = "sahara";
username = "dev";
git_root = "/home/dev/sahara/web3/a2a/x402-rs";
